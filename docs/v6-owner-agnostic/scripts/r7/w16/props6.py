...
if __name__ == "__main__":
    ...
    # C5: the scheduler-permutation figure section 1.1 quotes lives nowhere else in the tree. It was
    # run once in a throwaway script during the round-5 audit and then cited, which is the defect
    # Y250 names. Measured here so the citation is true because the harness re-derived it.
    #
