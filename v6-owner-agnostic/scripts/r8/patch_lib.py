# -*- coding: utf-8 -*-
"""Auditable spec patcher: every edit is an asserted old->new replacement, logged for changes-v6.md."""
import io, json, os, sys
SPEC = r"C:\Users\rdavi\OneDrive\Documents\Paradox Interactive\Europa Universalis IV\mod\per-good-trade\v6-owner-agnostic\per-good-trade-spec.md"
LOG  = os.path.join(os.path.dirname(os.path.abspath(__file__)), "edits6.json")
